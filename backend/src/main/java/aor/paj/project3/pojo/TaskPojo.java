...
public class TaskPojo {
    ...
    public TaskPojo(String id, String title, String description, int stateId, int priority, LocalDate startDate, LocalDate limitDate) {
        this.id = generateId();
        this.title = title;
